...
class inputConfigClass:
    def __init__(self,Nx1,Nx2,Nx3,dt,Nsteps):
        ...
        # Compute device
        import torch
        self.device = torch.device("cpu")#CUDA_Util.get_device()
...
def driver(argv):
    ...
    for _ in range(20):
        ...
        adj_PCL = Q_A_1['rhoU_A'].interior()[Nx1//2,Nx2//2,0]
    ...
    plt.tight_layout()
    plt.savefig('adjoint_convergence_2D_channel.pdf')
    plt.close()
