...
class inputConfigClass:
    def __init__(self,Nx1,Nx2,Nx3,dt,Nsteps):
        ...
        # Initial conditions
        self.IC_opt='planar_jet_spatial_RANS_coflow'

        # Nondimensional parameters
        self.Re = 6000 ## vel avg is 0.7037 without coflow
        self.Ma = 0.1
        ...
        self.dt     = dt
        self.Nsteps = Nsteps
        self.N_monitor = 100000
        self.turb_stat_start = 1000000000000000 #
        

        # Output options
        self.outDir = 'coflow_RANS_{}_Nx1_{}'.format(self.Re,self.Nx1)
...
def driver(argv):
    ...
    Nx1 = 768; Nx2 = 512; Nx3 = 1
    dt = 2.5e-3; Nsteps = 400000# Ma=0.1
